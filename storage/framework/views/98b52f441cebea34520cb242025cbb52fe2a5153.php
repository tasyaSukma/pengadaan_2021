                ...
                <table class="table table-hover text-nowrap" style="text-align: center;">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width:15%"><img style="width:70%;" src="<?php echo e(asset(Storage::url($p['gambar']))); ?>"></td>
                      ...
                      <td>
                        ...
                        <a target="_blank" href="<?php echo e(asset(Storage::url($p['laporan']))); ?>" class="btn btn-secondary">Lihat Laporan</a>
                        <?php endif; ?>
                      </td>
                      <td>
                      <?php if($p['status_pengajuan'] == "2"): ?>
                      ...
                      <hr>
                      <a href="/selesaiPengajuan/<?php echo e($p['id_pengajuan']); ?>" class="btn btn-primary konfirmasi"><i class="fa fa-check"></i> Diterima</a>
                      <a href="/tolakLaporan/<?php echo e($p['id_laporan']); ?>" class="btn btn-danger konfirmasi"><i class="fa fa-times"></i> Ditolak</a>
                      <?php endif; ?>
                      </td>
                    </tr>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/BKPSDM/pengadaan/resources/views/admin/laporan.blade.php ENDPATH**/ ?>