                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo e($adm->alamat); ?></td>
                      <td>
                        <button data-toggle="modal" data-target="#ubahModal" type="button" class="btn btn-secondary ubah" data-id_admin="<?php echo e($adm->id_admin); ?>" data-nama="<?php echo e($adm->nama); ?>" data-email="<?php echo e($adm->email); ?>" data-alamat="<?php echo e($adm->alamat); ?>">
                          <i class="fas fa-edit">Ubah</i></button>
                          <a class="komfirmasi" href="/hapusAdmin/<?php echo e($adm->id_admin); ?>">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/BKPSDM/pengadaan/resources/views/admin/list.blade.php ENDPATH**/ ?>