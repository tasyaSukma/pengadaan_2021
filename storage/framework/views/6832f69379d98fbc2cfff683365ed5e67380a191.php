                ...
                <table class="table table-hover text-nowrap text-center">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><img style="width:70%;" src="<?php echo e(asset(Storage::url($p['gambar']))); ?>"></td>
                      ...
                      <td>
                        ...
                        <hr>
                        <?php if($p['laporan'] == "-"): ?>                        
                        <form method="post" action="/tambahLaporan" enctype="multipart/form-data" role="form">
                          <?php echo e(csrf_field()); ?>

                          <input type="hidden" name="id_pengajuan" id="id_pengajuan" value="<?php echo e($p['id_pengajuan']); ?>">
                        ...
                        <?php else: ?>
                        <a href="<?php echo e(asset(Storage::url($p['laporan']))); ?>" class="btn btn-warning" target="_blank"><i class="fa fa-eye"> Lihat Laporan</i></a>
                        <?php endif; ?>
                        <?php endif; ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/BKPSDM/pengadaan/resources/views/supplier/riwayat_pengajuan.blade.php ENDPATH**/ ?>