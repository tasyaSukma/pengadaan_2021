                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <td><button class="btn btn-secondary detail" data-toggle="modal" data-target="#pengajuanModal"data-id_pengadaan="{{$pgd->id_pengadaan}}" data-nama_pengadaan="{{$pgd->nama_pengadaan}}" data-anggaran="{{$pgd->anggaran}}"> <i class="fas fa-plus" >Ajukan</button></i></td>
                      </tr>
                      @endforeach
                    </tbody>
                  </table>
